        ...
        onAnimationEnd={() => {
          if (transitionStage === "fadeOut") {
            ...
            <div className='body-left'>
                <div className = 'project-info-title'>system of a sound</div>
                ...
                <div className='project-info-split'>
                    ...
                    <ul className='project-buttons buttonParent desktop'>
                        <li className='left nothighlighted'><Link className="button" to="/projects/sonic">← BACK</Link></li>
